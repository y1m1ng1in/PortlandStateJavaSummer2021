...
public class UserRegistrationServlet extends HttpServletHelper {
  ...
  private void insertUser(HttpServletResponse response, String username, String password, String email, String address)
      throws IOException {
    ...
    try {
      if (this.storage.getUserByUsername(username) != null) {
        writeMessageAndSetStatus(response, username + " has already been registered", HttpServletResponse.SC_BAD_REQUEST);
        return;
      }

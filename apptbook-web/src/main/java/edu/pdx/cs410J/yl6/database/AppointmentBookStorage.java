...
public interface AppointmentBookStorage {
     ...
     */
    AppointmentBook<Appointment> getAllAppointmentsByOwner(String owner) throws StorageException;
     ...
     * @throws StorageException If any error occurs during read/write with storage
     */
    AppointmentBook<Appointment> getAppointmentsByOwnerWithBeginInterval(String owner, Date from, Date to)
     ...
     * @throws StorageException If any error occurs during read/write with storage
     */
    boolean insertAppointmentWithOwner(String owner, Appointment appointment) throws StorageException;
     ...
     * @throws StorageException If any error occurs during read/write with storage
     */
    AppointmentBook<AppointmentSlot> getAllBookableAppointmentSlotsByOwner(String owner) throws StorageException;
     ...
     * @throws StorageException If any error occurs during read/write with storage
     */
    boolean insertBookableAppointmentSlot(String owner, AppointmentSlot slot) throws StorageException;
     ...
     * @throws StorageException If any error occurs during read/write with storage
     */
    int bookAppointment(String owner, Appointment appointment, boolean authenticated) throws StorageException;

    /**
     * Insert a {@link User} instance to the storage
     *
     * @param user an <code>User</code> insatnce
     * @throws StorageException If any error occurs during read/write with storage
     */
    int insertUser(User user) throws StorageException;
